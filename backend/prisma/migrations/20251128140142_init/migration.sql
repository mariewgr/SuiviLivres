...
INSERT INTO "new_Book" ("authorId", "citations", "coverUrl", "createdAt", "id", "isRead", "rating", "readDate", "seriesId", "summary", "title", "updatedAt") SELECT "authorId", "citations", "coverUrl", "createdAt", "id", "isRead", "rating", "readDate", "seriesId", "summary", "title", "updatedAt" FROM "Book";
DROP TABLE "Book";
